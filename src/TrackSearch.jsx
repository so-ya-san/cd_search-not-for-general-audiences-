                                    ...
                                    <div >
                                            <button onClick={() => startEdit(index)}
                                                style={{
                                                    ...
                                                    borderRadius: '6px',
                                                    cursor: 'pointer',
                                                    marginRight: '8px' // ← 編集ボタンの右に8pxの余白を追加！
                                                }}

                                            >編集</button>
                                            <button onClick={() => deleteTrack(index)}
                                                style={{
                                                    backgroundColor: '#333333',
                                                    color: '#ffffff',
                                                    border: 'none',
                                ...
                                <button
                                    onClick={() => openRequestModal(index)}
                                        style={{
                                            ...
                                            borderRadius: '6px',
                                            cursor: 'pointer',
                                            marginTop: '12px', // ← 上に12pxの余白！
                                            width: '20%' // ← ボタンを横幅いっぱいにする
                                        }}
